(function(Scratch) {
  ...
  Scratch.translate.setup({
    en: {
      'booleanput.name': 'Booleanput',
      'booleanput.toBoolean': 'to boolean [INPUT]',
      'booleanput.toText': 'to text [INPUT]',
      'booleanput.toNumber': 'to number [INPUT]',
      'booleanput.runAsBool': 'run [SUBSTACK] as boolean',
      'booleanput.runAsReporter': 'run [SUBSTACK] and return [RET]',
      'booleanput.defaultResult': 'result'
    },
    es: {
      'booleanput.name': 'Booleanput',
      'booleanput.toBoolean': 'a booleano [INPUT]',
      'booleanput.toText': 'a texto [INPUT]',
      'booleanput.toNumber': 'a número [INPUT]',
      'booleanput.runAsBool': 'ejecutar [SUBSTACK] como booleano',
      'booleanput.runAsReporter': 'ejecutar [SUBSTACK] y devolver [RET]',
      'booleanput.defaultResult': 'resultado'
    }
  });
  ...
  class Booleanput {
    ...
    getInfo() {
      return {
        id: 'booleanput',
        name: Scratch.translate({ id: 'booleanput.name', default: 'Booleanput' }),
        color1: this.c1, color2: this.c2, color3: this.c3,
        blocks: [
          {
            opcode: 'bool',
            blockType: Scratch.BlockType.BOOLEAN,
            text: Scratch.translate({ id: 'booleanput.toBoolean', default: 'to boolean [INPUT]' }),
            arguments: { INPUT: { type: Scratch.ArgumentType.STRING, defaultValue: '' } }
          },
          {
            opcode: 'text',
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate({ id: 'booleanput.toText', default: 'to text [INPUT]' }),
            arguments: { INPUT: { type: Scratch.ArgumentType.BOOLEAN, defaultValue: false } }
          },
          {
            opcode: 'number',
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate({ id: 'booleanput.toNumber', default: 'to number [INPUT]' }),
            arguments: { INPUT: { type: Scratch.ArgumentType.BOOLEAN, defaultValue: false } }
          },
          {
            opcode: 'runAsBool',
            blockType: Scratch.BlockType.BOOLEAN,
            text: Scratch.translate({ id: 'booleanput.runAsBool', default: 'run [SUBSTACK] as boolean' }),
            branchCount: 1
          },
          {
            opcode: 'runAsReporter',
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate({ id: 'booleanput.runAsReporter', default: 'run [SUBSTACK] and return [RET]' }),
            branchCount: 1,
            arguments: {
              RET: { 
                type: Scratch.ArgumentType.STRING, 
                defaultValue: Scratch.translate({ id: 'booleanput.defaultResult', default: 'result' }) 
              }
            }
          }
        ]
